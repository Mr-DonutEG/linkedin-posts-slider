## Request 
add the full missing code of the table prepopulation using the given data in full line by line for the activation-deactivation.php file

### the prepopulating data for to use :
```
{
  "results": [
    {
...
### current version of activation-deactivation.php:
```
<?php
